...
//LQMS   
    ...
    function Da(e)
    {
    	...
    	var s;
    	var wordIndex = window.localStorage.getItem("wordIndex");
    	if(wordIndex)
    	{
    		s = parseInt(wordIndex, 10);
    	}
    	else
    	{
//alert("set word 0")    		
...
// LQMS
    ...
    {
    	var inc = window.localStorage.getItem("incrementWord");
    	if(inc && inc === "yes")
    	{
//alert("set incrementWord to null");    		
    		window.localStorage.setItem("incrementWord", null);

			// Progress to next solution word
			var wordIndexStr = window.localStorage.getItem("wordIndex");
			var wordIndex = parseInt(wordIndexStr);
			wordIndex = (wordIndex + 1) % La.length;
//alert("set word Index to " + wordIndex);
			window.localStorage.setItem("wordIndex", wordIndex.toString());
    ...
    function lastResultIsWin()
    {
    	var res = window.localStorage.getItem("lastResult");
    	if(res)
    	{
    		return res === "win" ? 1 : 0;
    	}
    ...
    function setLastResult(result)
    {
    	if(result)
    	{
    		window.localStorage.setItem("lastResult", "win");
    	}
    	else
    	{
    		window.localStorage.setItem("lastResult", "loss");
    	}
    	return result;
    }
    ...
    function Va(e)
    {
        ...
        a ? (o.guesses[t] += 1, s ? o.currentStreak += 1 : o.currentStreak = 1) : (o.currentStreak = 0, o.guesses.fail += 1), o.maxStreak = Math.max(o.currentStreak, o.maxStreak), o.gamesPlayed += 1, o.gamesWon += a ? 1 : 0, o.winPercentage = Math.round(o.gamesWon / o.gamesPlayed * 100), o.averageGuesses = Math.round(Object.entries(o.guesses).reduce((function(e, a)
            ...
            function(e)
            {
//LQMS        	alert("4. adding t local strorage:  name = " + Ya + " value = " + JSON.stringify(e));
    ...
    var Za = "IN_PROGRESS",
        ...
        ts = function(e)
        {
            ...
            function t()
            {
// LQMS            	alert("Called me");
                var e;
                s(this, t), n(p(e = a.call(this)), "tileIndex", 0), n(p(e), "rowIndex", 0), n(p(e), "solution", void 0), n(p(e), "boardState", void 0), n(p(e), "evaluations", void 0), n(p(e), "canInput", !0), n(p(e), "gameStatus", Za), n(p(e), "letterEvaluations",
                {}), n(p(e), "$board", void 0), n(p(e), "$keyboard", void 0), n(p(e), "$game", void 0), n(p(e), "today", void 0), n(p(e), "lastPlayedTs", void 0), n(p(e), "lastCompletedTs", void 0), n(p(e), "hardMode", void 0), n(p(e), "dayOffset", void 0), e.attachShadow(
                {
                    mode: "open"
                }), e.today = new Date;
                var o = za();

                return e.lastPlayedTs = o.lastPlayedTs, !e.lastPlayedTs || getNextWord() >= 1 ? (e.boardState = new Array(6).fill(""), e.evaluations = new Array(6).fill(null), e.solution = Da(e.today), e.dayOffset = Ga(e.today), e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.restoringFromLocalStorage = !1, ja(
// LQMS                return e.lastPlayedTs = o.lastPlayedTs, !e.lastPlayedTs || Na(new Date(e.lastPlayedTs), e.today) >= 1 ? (e.boardState = new Array(6).fill(""), e.evaluations = new Array(6).fill(null), e.solution = Da(e.today), e.dayOffset = Ga(e.today), e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.restoringFromLocalStorage = !1, ja(
                {
                    rowIndex: e.rowIndex,
...
//LQMS - check overflows                            
                        ...
                        {
                            isWin: l,
                            isStreak: !!this.lastCompletedTs && 1 === lastResultIsWin(),
    ...
    var ds = [
        ...
        us = function(e)
        {
            ...
            {
                var e;
                return s(this, t), n(p(e = a.call(this)), "_letterEvaluations",
                {}), e.attachShadow(
                {
                    mode: "open"
                }), e
    ...
    var Ms = {
        ...
        Os = function(e)
        {
            ...
            function t()
            {
                ...
                {}), n(p(e), "gameApp", void 0), e.attachShadow(
                {
                    mode: "open"
                }), e.stats = Xa(), e
            }
            return o(t, [
            {
                ...
                value: function()
                {
                        ...
                        })), this.gameApp.gameStatus !== Za)
                    {
                        ...
                        p.appendChild(m), this.shadowRoot.querySelector("button#next-button").addEventListener("click", (function(a){
                        	a.preventDefault(), a.stopPropagation();
window.localStorage.setItem("incrementWord", "yes");
location.reload();
